...
from src.utils.helper import Voc, BinVoc, gpu_init_pytorch, create_save_directories, get_latest_checkpoint, count_parameters
from src.utils.logger import get_logger
# from src.model import build_model, train_model
from src.model_iter import build_model, train_model, train_model_iter
...
def main():
	...
	if is_train:
		...
		if config.itr:
			train_model_iter(model, voc, device, config, logger)	
		else:
