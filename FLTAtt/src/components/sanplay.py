...
class TransformerCLF(nn.Module):
    def __init__(self, ntoken=4, noutputs=1, d_model=4, nhead=1, d_ffn=8, nlayers=1, dropout=0.0, pos_encode_type ='absolute'):
        ...
        if pos_encode_type == 'absolute':
            ...
            self.pos_encoder = LearnablePositionalEncoding(d_model, dropout, max_len= 200)
    ...
    def init_weights(self, weight_init= 10, inp_init = 1.0, dec_init= 1, bias=False):
    ...
    def init_xavier_weights(self, inp_init = 1.0, dec_init= 1, bias= False):
